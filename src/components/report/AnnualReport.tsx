    ...
    <div className="max-w-[960px] mx-auto">
      ...
      <div className="mb-6 fade fd3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <button
            className="csv-btn"
            onClick={() => downloadCsv(generateCardsCsv(yearCards), `tcgvault_取引明細_${year}.csv`)}
          >
            <div
              className="csv-icon"
          ...
          <button
            className="csv-btn"
            onClick={() => downloadCsv(generateExpensesCsv(yearExpenses), `tcgvault_経費明細_${year}.csv`)}
          >
            <div
              className="csv-icon"
          ...
          <button
            className="csv-btn"
            onClick={() => downloadCsv(generateFreeeCsv(cards, expenses, year), `tcgvault_仕訳_freee_${year}.csv`)}
          >
            <div
              className="csv-icon"
